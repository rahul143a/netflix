    ...
    <header class="">
      <div class="navbar">
        ...
        <a href="#" class="navbar-brand">
          <img src="img/nt4.png" alt="" style="width: 180px;">
        </a>
        ...
        <div class="navbar-actions">
          ...
          <a href="netflix2.jsp" class="navbar-signin">
            <span>Sign out</span>
    ...
    <footer>
      ...
      <div class="footer-content">
        ...
        <div class="footer-brand">
          <img src="img/nt4.png" alt="" style=" width: 180px; height: 30px;" alt="" class="footer-logo">
